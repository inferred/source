...
import static org.inferred.internal.testing.integration.SourceBuilder.getTypeNameFromSource;
...
public class TestBuilderTest {
  ...
  public void testUniqueNames() throws IOException {
    ...
    assertEquals(
        "org.inferred.internal.testing.integration.generatedcode.TestBuilderTest",
        getTypeNameFromSource(source1.getCharContent(false)));
    JavaFileObject source2 = new TestBuilder().build();
    assertEquals(
        "org.inferred.internal.testing.integration.generatedcode.TestBuilderTest__2",
    ...
    assertEquals(
        "org.inferred.internal.testing.integration.generatedcode.TestBuilderTest__3",
  ...
  public void testInnerClassNames() throws IOException {
    ...
    assertThat(result).contains(
        "org.inferred.internal.testing.integration.TestBuilderTest.InnerClass");
  }
}
